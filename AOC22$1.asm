...
BLANK_LINE EQU *
         ...
         CR    R4,R7          Is this > than max1?
         JL    NOT_GRMAX1     Nope
         LR    R8,R7          Yes, save max register 1 in 2
         LR    R9,R8          Yes, save max register 2 in 3
         LR    R7,R4          Yes, save max register in 1
         J     GO_SHOW
NOT_GRMAX1 EQU *
         CR    R4,R8          Is this > than max2?
         JL    NOT_GRMAX2     Nope
         LR    R9,R8          Yes, save max register 2 in 3
         LR    R8,R4          Yes, save max register in 2
         J     GO_SHOW
NOT_GRMAX2 EQU *
         CR    R4,R9          Is this > than max3?
         JL    GO_SHOW        Nope
         LR    R9,R4          Yes, save max register in 3
*        ST    R7,BIN_VAL
